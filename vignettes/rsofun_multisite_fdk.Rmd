...
Is possible to run the model with different sites. To do so, referr to [README[(https://github.com/FrancescoGrossi-unimi/rsofundemo/blob/main/README.md).
The result of the model will be inserted in the folder [img](https://github.com/FrancescoGrossi-unimi/rsofundemo/tree/main/vignettes/img).

```{r}
# output path for images
out_path <- paste0(getwd(),"/vigenttes/fig/") # path output for the images
path  <- paste0(getwd(),"/data/")     #instert your path of .rda files 
...
The output is not directly visualized here but is located in [img](https://github.com/FrancescoGrossi-unimi/rsofundemo/tree/main/vignettes/img). The model result is shown separately for each site.
